...
# 健康 RAG LLM 配置（仅使用新字段）
LLM_BASE_URL = ROOT_ENV_CONFIG("LLM_BASE_URL", default="http://localhost:11434")
LLM_API_KEY = ROOT_ENV_CONFIG("LLM_API_KEY", default="")
LLM_MODEL = ROOT_ENV_CONFIG(
    "LLM_MODEL",
    default=ROOT_ENV_CONFIG("AI_MODEL_NAME", default="deepseek-r1:1.5b"),
)
LLM_TIMEOUT = ROOT_ENV_CONFIG("LLM_TIMEOUT", default=60, cast=int)

# Embedding & Qdrant 配置
EMBEDDING_BASE_URL = ROOT_ENV_CONFIG("EMBEDDING_BASE_URL", default=LLM_BASE_URL)
EMBEDDING_API_KEY = ROOT_ENV_CONFIG("EMBEDDING_API_KEY", default=LLM_API_KEY)
EMBEDDING_MODEL = ROOT_ENV_CONFIG(
    "EMBEDDING_MODEL",
    default="text-embedding-3-small",
)
EMBEDDING_TIMEOUT = ROOT_ENV_CONFIG(
    "EMBEDDING_TIMEOUT",
    default=30,
    cast=int,
)
EMBEDDING_BATCH_SIZE = ROOT_ENV_CONFIG("EMBEDDING_BATCH_SIZE", default=10, cast=int)
QDRANT_URL = ROOT_ENV_CONFIG("QDRANT_URL", default="http://127.0.0.1:6333")
QDRANT_COLLECTION = ROOT_ENV_CONFIG("QDRANT_COLLECTION", default="health_rag_chunks")
QDRANT_TIMEOUT = ROOT_ENV_CONFIG("QDRANT_TIMEOUT", default=15, cast=int)
RAG_TOP_K = ROOT_ENV_CONFIG("RAG_TOP_K", default=8, cast=int)
RAG_VECTOR_TOP_K = ROOT_ENV_CONFIG("RAG_VECTOR_TOP_K", default=50, cast=int)
RAG_SPARSE_TOP_K = ROOT_ENV_CONFIG("RAG_SPARSE_TOP_K", default=50, cast=int)
RAG_FUSED_TOP_K = ROOT_ENV_CONFIG("RAG_FUSED_TOP_K", default=50, cast=int)
RAG_SPARSE_METHOD = ROOT_ENV_CONFIG("RAG_SPARSE_METHOD", default="bm25")
RAG_ENABLE_QUERY_EXPANSION = ROOT_ENV_CONFIG(
    "RAG_ENABLE_QUERY_EXPANSION",
    default=True,
    cast=bool,
)
RERANK_ENABLED = ROOT_ENV_CONFIG("RERANK_ENABLED", default=True, cast=bool)
RERANK_BASE_URL = ROOT_ENV_CONFIG("RERANK_BASE_URL", default=LLM_BASE_URL)
RERANK_API_KEY = ROOT_ENV_CONFIG("RERANK_API_KEY", default=LLM_API_KEY)
RERANK_MODEL = ROOT_ENV_CONFIG("RERANK_MODEL", default="qwen3-rerank")
RERANK_TOP_N = ROOT_ENV_CONFIG("RERANK_TOP_N", default=20, cast=int)
RERANK_TIMEOUT = ROOT_ENV_CONFIG("RERANK_TIMEOUT", default=30, cast=int)
